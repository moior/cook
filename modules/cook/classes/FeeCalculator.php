...
class FeeCalculator
{
    ...
    function __construct(){
        ...
        $this->danka_by_amount['무선'] = array( /*수량상관없이 기본  */
            '기본비용-A4' => "550000", '기본수량-A4' => "1000", '초과비용-A4' => "70", /*1000권 초과부터는 1천권당 7만 원 */
            '기본비용-B5' => "480000", '기본수량-B5' => "1000", '초과비용-B5' => "70",
            '기본비용-A5' => "400000", '기본수량-A5' => "1000", '초과비용-A5' => "60",
            '기본비용-B6' => "310000", '기본수량-B6' => "1000", '초과비용-B6' => "60",
            '기본비용-A6' => "300000", '기본수량-A6' => "1000", '초과비용-A6' => "60",
        );
        $this->danka_by_amount['스프링'] = array( /*1000권 이하는 무조건 30만원, 3천권하면 A6 250원 A5 280원*/
            /*'기본비용' => "350000", '기본수량' => "1000", '1000' => "320",*/
            '기본비용-A4' => "380000", '기본수량-A4' => "1000", '초과비용-A4' => "350", /*1000권 초과부터는 1천권당 7만 원 */
            '기본비용-B5' => "340000", '기본수량-B5' => "1000", '초과비용-B5' => "330",
            '기본비용-A5' => "320000", '기본수량-A5' => "1000", '초과비용-A5' => "310",
            '기본비용-B6' => "300000", '기본수량-B6' => "1000", '초과비용-B6' => "290",
            '기본비용-A6' => "300000", '기본수량-A6' => "1000", '초과비용-A6' => "290",
        );
        ...
        $this->danka['용지-국전'] = array( /*대유기획 홈피. korea-a.com = http://appleto.n4.cc/etc/paper1.htm*/
            ...
            '특수지' => 157000, /*DB로 관리해야할듯...*/
            '특수지 80g' => 154000, /*표지에서 선택시*/
            '특수지 100g' => 155000,
        );
    ...
    function feeJebon($real = "real", $paper_name = null, $size = null)
    {
        ...
        if($real == "real"){
            ...
            /*무선과 스프링은 가격 정확히 알아서.. 중철과 양장은 해야함. */
            ...
            return $제본비;
            $제본단가 = $this->danka_by_amount['스프링'][$this->userSetting['제본']];
        }else{
        }
    }
