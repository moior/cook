...
class FeeCalculator
{
    ...
    function __construct(){
        ...
        $this->danka_v2['무선'] = array( /*1R 비용. 보통 1도 1R(1장 16매=8권x500장=>4000권)에 10000원(내지) ~ 15000원(표지)*/
            'A4' => array(
                '0' => "0",                '100' => "255000",                '1000' => "550000", /*1000권 초과부터는 1천권당 7만 원 */
                '초과수량' => "70",
            ),
            'B5' => array(
                '0' => "0",                '100' => "238000",                '1000' => "480000",
                '초과수량' => "70",
            ),
            'A5' => array(
                '0' => "0",                '100' => "210000",                '1000' => "400000",
                '초과수량' => "60",
            ),
            'B6' => array(
                '0' => "0",                '100' => "200000",                '1000' => "310000",
                '초과수량' => "60",
            ),
            'A6' => array(
                '0' => "0",                '100' => "190000",                '1000' => "300000",
                '초과수량' => "60",
            ),
        );
        ...
        $this->danka_v2['스프링'] = array( /*1R 비용. 보통 1도 1R(1장 16매=8권x500장=>4000권)에 10000원(내지) ~ 15000원(표지)*/
            'A4' => array( /*1000권 이하는 무조건 30만원, 3천권하면 A6 250원 A5 280원*/
                '0' => "0",                '100' => "265000",                '1000' => "450000",
                '초과수량' => "350",
            ),
            'B5' => array(
                '0' => "0",                '100' => "245000",                '1000' => "420000",
                '초과수량' => "330",
            ),
            'A5' => array(
                '0' => "0",                '100' => "233000",                '1000' => "410000",
                '초과수량' => "310",
            ),
            'B6' => array(
                '0' => "0",                '100' => "226000",                '1000' => "390000",
                '초과수량' => "300",
            ),
            'A6' => array(
                '0' => "0",                '100' => "215000",                '1000' => "300000",
                '초과수량' => "290",
            ),
        );
        ...
        $this->danka_v2['중철'] = array( /*1R 비용. 보통 1도 1R(1장 16매=8권x500장=>4000권)에 10000원(내지) ~ 15000원(표지)*/
            'A4' => array(
                '0' => "0",                '100' => "150000",                '1000' => "350000",
                '초과수량' => "25",
            ),
            'B5' => array(
                '0' => "0",                '100' => "145000",                '1000' => "310000",
                '초과수량' => "24",
            ),
            'A5' => array(
                '0' => "0",                '100' => "144000",                '1000' => "280000",
                '초과수량' => "23",
            ),
            'B6' => array(
                '0' => "0",                '100' => "142000",                '1000' => "250000",
                '초과수량' => "22",
            ),
            'A6' => array(
                '0' => "0",                '100' => "138000",                '1000' => "230000",
                '초과수량' => "21",
            ),
        );
        $this->danka_v2['양장'] = array( /*1R 비용. 보통 1도 1R(1장 16매=8권x500장=>4000권)에 10000원(내지) ~ 15000원(표지)*/
            'A4' => array(
                '0' => "0",                '100' => "365000",                '1000' => "1100000",
                '초과수량' => "900",
            ),
            'B5' => array(
                '0' => "0",                '100' => "345000",                '1000' => "1010000",
                '초과수량' => "850",
            ),
            'A5' => array(
                '0' => "0",                '100' => "330000",                '1000' => "980000",
                '초과수량' => "840",
            ),
            'B6' => array(
                '0' => "0",                '100' => "305000",                '1000' => "950000",
                '초과수량' => "820",
            ),
            'A6' => array(
                '0' => "0",                '100' => "138000",                '1000' => "910000",
                '초과수량' => "800",
            ),
        );
        ...
        $this->danka['용지-국전'] = array( /*대유기획 홈피. korea-a.com = http://appleto.n4.cc/etc/paper1.htm*/
            '' => 0,
            ' ' => 0,
            '모조 80g' => 26584, /*표지에서 그냥 모조지 선택시*/
            '모조 180g' => 56500, /*표지에서 그냥 모조지 선택시*/
            '모조 250g' => 83400,
            '모조 300g' => 108400,
